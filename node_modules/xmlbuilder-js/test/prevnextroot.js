(function() {
  ...
  vows.describe('Navigation').addBatch({
    'Prev/next/root': {
      topic: function() {
        return xmlbuilder.create('test5', {}, {}, {
          headless: true
        }).e('node', '1').up().e('node', 'element').up().e('node', '2').prev().prev().att('prev', 'yes').next().next().att('next', 'yes').root().att('root', 'yes');
      },
